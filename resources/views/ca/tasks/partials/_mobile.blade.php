<div class="bg-white shadow rounded p-4 md:hidden">
    <div class="space-y-3">
        @forelse($tasks as $task)
            <div x-data="taskToggle({{ $task->id }})" class="border rounded-xl bg-white shadow-sm border-l-4" style="border-left-color: {{ $taskColor }}; background-color: {{ $taskBackgroundColor }}">
